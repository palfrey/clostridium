...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8250__auto__,writer__8251__auto__,opt__8252__auto__){
return cljs.core._write(writer__8251__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14161 = o;
(G__14161[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__14163__i < G__14163__a.length) {G__14163__a[G__14163__i] = arguments[G__14163__i + 0]; ++G__14163__i;}
  args = new cljs.core.IndexedSeq(G__14163__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__7613__auto__ = !((jsprops == null));
if(and__7613__auto__){
var and__7613__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__14167 = jsprops;
(G__14167["defaultValue"] = value);

(G__14167["onChange"] = ((function (G__14167,v,value,on_change){
return (function (p1__14166_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__14166_SHARP_);
});})(G__14167,v,value,on_change))
);
...
var vec__14170 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14170,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14170,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14170,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___14174 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___14174 == null)){
} else {
var key_14175 = temp__4661__auto___14174;
(jsprops["key"] = key_14175);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14176 = reagent.impl.template.__GT_NativeWrapper();
(G__14176["name"] = c);
...
var G__14177 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__14177) : reagent.impl.template.as_element.call(null,G__14177));
} else {
...
var len__8789__auto___14182 = arguments.length;
var i__8790__auto___14183 = (0);
while(true){
if((i__8790__auto___14183 < len__8789__auto___14182)){
args__8796__auto__.push((arguments[i__8790__auto___14183]));

var G__14184 = (i__8790__auto___14183 + (1));
i__8790__auto___14183 = G__14184;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8797__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14180){
var G__14181 = cljs.core.first(seq14180);
var seq14180__$1 = cljs.core.next(seq14180);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14181,seq14180__$1);
});
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Hiccup form should not be empty"], 0))),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(pos? (count v))")].join('')));
}

var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(v,(0),null);
if(reagent.impl.template.valid_tag_QMARK_(tag)){
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup form"], 0))),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(valid-tag? tag)")].join('')));
}
...
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Invalid Hiccup tag"], 0))),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(= \">\" n)")].join('')));
}

if((typeof comp === 'string') || (cljs.core.fn_QMARK_(comp))){
} else {
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Assert failed: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(v,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Expected React component in"], 0))),cljs.core.str.cljs$core$IFn$_invoke$arity$1("\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1("(or (string? comp) (fn? comp))")].join('')));
}
...
break;
default:
var G__14187 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14187;
continue;
...
var n__8565__auto___14189 = a.length;
var i_14190 = (0);
while(true){
if((i_14190 < n__8565__auto___14189)){
(a[i_14190] = reagent.impl.template.as_element((a[i_14190])));

var G__14191 = (i_14190 + (1));
i_14190 = G__14191;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8565__auto___14192 = a.length;
var i_14193 = (0);
while(true){
if((i_14193 < n__8565__auto___14192)){
var val_14194 = (a[i_14193]);
if((cljs.core.vector_QMARK_(val_14194)) && ((reagent.impl.template.key_from_vec(val_14194) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14193] = reagent.impl.template.as_element(val_14194));
...
var ctx = ({});
var vec__14196 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14196,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14196,(1),null);
if(cljs.core.truth_(derefed)){
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Warning: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Reactive deref not supported in lazy seq, ","it should be wrapped in doall"], 0)))].join(''));
} else {
}
} else {
}
...
if(cljs.core.truth_(reagent.debug.has_console)){
(cljs.core.truth_(reagent.debug.tracking)?reagent.debug.track_console:console).warn([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Warning: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(x,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Every element in a seq should have a unique :key"], 0)))].join(''));
} else {
}
} else {
}
...
var G__14199 = (cljs.core.count(argv) - first_child);
switch (G__14199) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__14199){
