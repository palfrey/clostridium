...
var or__27939__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj34810 = {"detail":data};
return obj34810;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27927__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27927__auto__)){
var and__27927__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__34817 = cljs.core._EQ_;
var expr__34818 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34817.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34818))){
return ((function (pred__34817,expr__34818){
return (function (p1__34811_SHARP_){
return console.warn(p1__34811_SHARP_);
});
;})(pred__34817,expr__34818))
} else {
if(cljs.core.truth_(pred__34817.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34818))){
return ((function (pred__34817,expr__34818){
return (function (p1__34812_SHARP_){
return console.debug(p1__34812_SHARP_);
});
;})(pred__34817,expr__34818))
} else {
if(cljs.core.truth_(pred__34817.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34818))){
return ((function (pred__34817,expr__34818){
return (function (p1__34813_SHARP_){
return console.error(p1__34813_SHARP_);
});
;})(pred__34817,expr__34818))
} else {
return ((function (pred__34817,expr__34818){
return (function (p1__34814_SHARP_){
return console.log(p1__34814_SHARP_);
});
;})(pred__34817,expr__34818))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34821){
...
var eval_fn = cljs.core.get.call(null,map__34822__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34824_SHARP_);
});})(new_def))
);
...
return (function (p__34825){
var vec__34826 = p__34825;
var ky = cljs.core.nth.call(null,vec__34826,(0),null);
...
if(cljs.core.truth_((function (){var and__27927__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1502751513602
